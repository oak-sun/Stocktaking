...
public class EquipmentUpdateDTO {
    ...
    public Equipment toEntity(final Equipment equipment) {
        final Equipment.EquipmentBuilder builder = equipment.toBuilder();
        ...
        getStockIdentifier().map(builder::stockIdentifier);
