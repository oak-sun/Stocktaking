...
public class ArchitectureComponentsTest extends ArchitectureBaseTest {
    ...
    class ControllersTest {
        ...
        @Test
        @DisplayName(
                "Controllers should be accordingly annotated" +
                " and reside in Infrastructure package")
        ...
        @Test
        @DisplayName(
                "Controller Advices should be accordingly annotated" +
                " and reside in Infrastructure package")
        void givenControllerAdvice_shouldAnnotated() {
            classes()
                    .that()
                    .haveSimpleName("ExceptionController")
                    .should()
        ...
        void givenController_shouldNotAccessRepositoryComponents() {
            noClasses()
                    ...
                    .should()
                    .dependOnClassesThat()
                    .resideInAnyPackage("..infrastructure.dao..")
                    .check(classes);
        }
    }
    ...
    class RouterTest {
        ...
        @Test
        @DisplayName(
                "routers should be accordingly annotated" +
                " and reside in the Infrastructure package")
    ...
    class HandlerTest {
        ...
        @Test
        @DisplayName(
                "handlers should be accordingly annotated" +
                " and reside in the Infrastructure package")
    ...
    class ServiceTest {
        ...
        @Test
        @DisplayName(
                "Service should be accordingly annotated" +
                " and reside in Api package")
    ...
    class RepositoryTest {
        ...
        @Test
        @DisplayName(
                "Repository should be accordingly annotated" +
                " and reside in ..infrastructure.sql package")
